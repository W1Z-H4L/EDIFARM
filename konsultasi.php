		...
		<div class="main-container">
			<div class="pd-ltr-20 xs-pd-20-10">
				...
				<div class="row clearfix">
					<?php 
					$query = "SELECT * FROM consul INNER JOIN jadwal ON consul.id_jadwal = jadwal.id_jadwal INNER JOIN user ON jadwal.id_user=user.id_user INNER JOIN lahan ON user.id_lahan = lahan.id_lahan WHERE consul.status='belum'";
					$result = mysqli_query($koneksi,$query);
